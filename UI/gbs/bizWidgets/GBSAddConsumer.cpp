#include "GBSAddConsumer.h"
#include "ui_GBSAddConsumer.h"

GBSAddConsumer::GBSAddConsumer(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::GBSAddConsumer)
{
    ui->setupUi(this);
...
GBSAddConsumer::~GBSAddConsumer()
{
    delete ui;
}


void GBSAddConsumer::mousePressEvent(QMouseEvent *event)
{
...
void GBSAddConsumer::mouseMoveEvent(QMouseEvent *event)
{
